              ...
              <>
                <View style={styles.sliderWrapper}>
                  ...
                  <Slider
                    ...
                    thumbTintColor={themeColor.sliderThumb}
                  />
                </View>
                <View style={styles.checkboxRow}>
                  <BouncyCheckbox
                    ...
                    fillColor={themeColor.checkboxFill}
                    iconStyle={{ borderColor: themeColor.checkboxBorder }}
                    size={24}
                    innerIconStyle={{ borderWidth: 2 }}
                    style={styles.checkbox}
                  />
                  <Text
                    style={[styles.heading, { color: themeColor.text }]}
                    onPress={() => setLowerCase(!lowerCase)}
                  >
                    Include lowercase
                  </Text>
